            ...
            content={
              <div className="flex flex-col gap-4">
                <CardLayout
                  ...
                  // Controlled by the app's own theme store for now, so this and the sidebar's
                  // toggle stay one setting.
                  content={<ThemePicker value={theme} onValueChange={setTheme} />}
                />
